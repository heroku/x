...
func TestGetOrRegisterCounter(t *testing.T) {
	...
	t.Run("with prefix", func(t *testing.T) {
		p := testmetrics.NewProvider(t)
		r := NewRegistry(p)
		runCounterTests(t, RegistryWithPrefix(r, "prefix"), p, "prefix.")
	})
}
...
func TestGetOrRegisterGauge(t *testing.T) {
	...
	t.Run("with prefix", func(t *testing.T) {
		p := testmetrics.NewProvider(t)
		r := NewRegistry(p)
		runGaugeTests(t, RegistryWithPrefix(r, "prefix"), p, "prefix.")
	})
}
...
func TestGetOrRegisterHistogram(t *testing.T) {
	...
	t.Run("with prefix", func(t *testing.T) {
		p := testmetrics.NewProvider(t)
		r := NewRegistry(p)
		runHistogramTests(t, RegistryWithPrefix(r, "prefix"), p, "prefix.")
	})
}
