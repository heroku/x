...
type PProf struct {
	...
	MutexProfileFraction int `env:"DEBUG_PPROF_MUTEX_PROFILE_FRACTION,default=2"`
	...
	BlockProfileRate int `env:"DEBUG_PPROF_BLOCK_PROFILE_RATE,default=10"`
	...
	MemProfileRate int  `env:"DEBUG_PPROF_MEM_PROFILE_RATE,default=524288"`
